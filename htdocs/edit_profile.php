...
if (empty($submit))
{
    ...
    <tr><th>Email:</th><td><input maxlength="50" name="email" size="30" type="text" value="<?php echo strip_tags($user->email); ?>" /></td></tr>
    ...
    <tr><th>Mobile:</th><td><input maxlength="50" name="mobile" size="30" type="text" value="<?php echo user_mobile($sit[2]) ?>" /></td></tr>
