...
switch ($_REQUEST['action'])
{
    case 'install':
        ...
        $path = "{$CONFIG['application_fspath']}htdocs/plugins/";
    ...
    case 'installdashboard':
        ...
        if (is_array($dashboardcomponents))
        {
            ...
            else
            {
                ...
                {
                    include ("{$CONFIG['application_fspath']}htdocs/plugins/dashboard_{$comp}.php");
    ...
    default:
        ...
        while ($dashboardnames = mysql_fetch_object($result))
        {
            ...
            $version = 1;
            include ("{$CONFIG['application_fspath']}htdocs/plugins/dashboard_{$dashboardnames->name}.php");
