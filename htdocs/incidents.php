...
$selectsql = "SELECT incidents.id, escalationpath, externalid, title, owner, towner, priority, status, siteid, forenames, surname, phone, email, incidents.maintenanceid, ";
