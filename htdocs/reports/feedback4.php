...
$msql .= "feedbackreport.id AS reportid, contacts.id AS contactid, sites.id AS siteid \n";
$msql .= "FROM feedbackreport, incidents, contacts, sites, closingstatus WHERE feedbackreport.incidentid=incidents.id \n";
