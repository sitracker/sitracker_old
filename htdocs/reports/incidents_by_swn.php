<?php
// incidents_by_sw.php - Dupe of incidents_by_software.php commited as it contains so CSV code

// FIXME merge back into incidents_by_software and make CSV nicer than inline
...
else
{
    ...
    for($i = 0; $i < $c; $i++)
    {
        ...
        $sqlN .= " AND opened >= '{$startdate}' AND opened <= '{$enddate}' ORDER BY opened";
