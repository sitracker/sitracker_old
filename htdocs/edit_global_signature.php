...
if(!empty($signature)){
	...
	switch($formaction)
	{
		case 'add':
			...
			confirmation_page("2", "main.php" . $id, "<h2>Edit Successful</h2><p align='center'>Please wait while you are redirected...</p>");
			include('htmlfootersvn statu.inc.php');
			break;
		case 'edit':
	...
	//echo "<p align='center'><strong>Global Signature</strong>: A signature to insert at the bottom of outgoing emails.  It's recommended that you begin this signature with two dashes, a space and a line feed.<br /><br />";
	
	echo "<p align='center'>One of the signatures will be choosen at random and inserted at the bottom of outgoing emails. It's recommended that you begin this signature with two dashes, a space and a line feed.<br /><br />";
	...
	{		
		$id = $signature['id'];
		echo "<tr>";
//		echo "<td class='shade1' width='70%'>".stripslashes($signature['signature'])."</td>";		
		echo "<td class='shade1' width='70%'>".ereg_replace("\n", "<br />", $signature['signature'])."</td>";		
		echo "<td class='shade2' align='center'><a href=edit_global_signature.php?action=edit&sig_id=$id>edit</a> | <a href=edit_global_signature.php?action=delete&sig_id=$id>delete</a></td>";
		echo "</tr>";
	}
