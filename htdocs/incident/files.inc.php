    ...
    foreach($dirarray AS $dir)
    {
        ...
        else
        {
            ...
            if (in_array("{$dir}{$delim}mail.eml",$tempfarray))
            {
                ...
                echo "<p>These files arrived by <a href='{$CONFIG['application_webpath']}{$incidentid}/{$dirname}/mail.eml'>email</a>, jump to the appropriate <a href='incident.php?id=$incidentid&amp#$updateid'>entry in the log</a></p>";
            }
