...
$upgrade_schema[335]["t200805211129"] = "INSERT INTO `{$dbNoticeTemplates}` (`name`, `type`, `description`, `text`, `linktext`, `link`, `durability`) VALUES('NOTICE_INCIDENT_CREATED', 3, 'Used when a new incident has been created', 'Incident {incidentid} - {incidenttitle} has been logged', 'View Incident', 'javascript:incident_details_window({incidentid})', 'sticky');";
$upgrade_schema[335]["t200805211130"] = "INSERT INTO `{$dbNoticeTemplates}` (`name`, `type`, `description`, `text`, `linktext`, `link`, `durability`) VALUES('NOTICE_INCIDENT_ASSIGNED', 3, 'Used when a new incident is assigned to you', 'Incident {incidentid} - {incidenttitle} has been assigned to {userrealname}', 'View Incident', 'javascript:incident_details_window({incidentid})', 'sticky');";
$upgrade_schema[335]["t200805211131"] = "INSERT INTO `{$dbNoticeTemplates}` (`name`, `type`, `description`, `text`, `linktext`, `link`, `durability`) VALUES('NOTICE_INCIDENT_NEARING_SLA', 3, 'Used when one of your incidents nears an SLA', 'Incident {incidentid} - {incidenttitle}: {nextsla} due in {nextslatime}', 'View Incident', 'javascript:incident_details_window({incidentid})', 'sticky');";
$upgrade_schema[335]["t200805211132"] = "INSERT INTO `{$dbNoticeTemplates}` (`name`, `type`, `description`, `text`, `linktext`, `link`, `durability`) VALUES('NOTICE_LANGUAGE_DIFFERS', 3, 'Occurs when a user logs in with a different language to their profile language', 'Your current langauge ({currentlang}) is different from your profile language ({profilelang})', 'Keep current language', '{applicationurl}edit_profile.php?mode=savesessionlang', 'sticky');";
$upgrade_schema[335]["t200805211133"] = "INSERT INTO `{$dbNoticeTemplates}` (`name`, `type`, `description`, `text`, `linktext`, `link`, `durability`) VALUES('NOTICE_NEW_CONTACT', 3, 'Occurs when a new contact is added', '{contactname} has been added as a contact to {sitename} by {userrealname}', 'View Contact', '{applicationurl}contact_details.php?id={contactid}', 'sticky');";
...
$upgrade_schema[335]["t200805211135"] = "INSERT INTO `{$dbNoticeTemplates}` (`name`, `type`, `description`, `text`, `linktext`, `link`, `durability`) VALUES('NOTICE_KB_CREATED', 3, 'Used when a new Knowledgebase article is created', 'KB Article {kbname} has been created by {userrealname}', 'View Article', '{sitpath}kbarticle?id={kbid}', 'sticky');";
$upgrade_schema[335]["t200805211136"] = "INSERT INTO `{$dbNoticeTemplates}` (`name`, `type`, `description`, `text`, `linktext`, `link`, `durability`) VALUES('NOTICE_NEW_HELD_EMAIL', 3, 'Used when there is a new email in the holding queue', 'There is a new email in the holding queue', 'View Holding Queue', '{sitpath}review_incoming_updates.php', 'sticky');";
$upgrade_schema[335]["t200805211137"] = "INSERT INTO `{$dbNoticeTemplates}` (`name`, `type`, `description`, `text`, `linktext`, `link`, `durability`) VALUES('NOTICE_MINS_HELD_EMAIL', 3, 'Used when there is a new email in the holding queue for x minutes', 'There has been an email in the holding queue for {holdingmins} minutes', 'View Holding Queue', '{sitpath}/review_incoming_updates.php', 'sticky');";
$upgrade_schema[335]["t200805211138"] = "INSERT INTO `{$dbNoticeTemplates}` (`name`, `type`, `description`, `text`, `linktext`, `link`, `durability`) VALUES('NOTICE_SIT_UPGRADED', 3, 'Used when the system is upgraded', '{applicationshortname} has been upgraded to {applicationversion}', 'What\'s New?', '{sitpath}releasenotes.php?v={applicationversion}', 'sticky');";
$upgrade_schema[335]["t200805211139"] = "INSERT INTO `{$dbNoticeTemplates}` (`name`, `type`, `description`, `text`, `linktext`, `link`, `durability`) VALUES('NOTICE_USER_SET_TO_AWAY', 3, 'Used when a watched user goes away', '{userrealname} is now [b]not accepting[/b] incidents', NULL, '', 'sticky');";
$upgrade_schema[335]["t200805211140"] = "INSERT INTO `{$dbNoticeTemplates}` (`name`, `type`, `description`, `text`, `linktext`, `link`, `durability`) VALUES('NOTICE_USER_RETURNS', 3, 'Used when a user sets back to accepting', '{userrealname} is now [b]accepting[/b] incidents', NULL, NULL, 'sticky');";
$upgrade_schema[335]["t200805211141"] = "INSERT INTO `{$dbNoticeTemplates}` (`name`, `type`, `description`, `text`, `linktext`, `link`, `durability`) VALUES('NOTICE_INCIDENT_CLOSED', 3, 'Occurs when an incident is closed', '{incidentid} - {incidentname} has been closed by {userrealname}', NULL, NULL, 'sticky');";
$upgrade_schema[335]["t200805211142"] = "INSERT INTO `{$dbNoticeTemplates}` (`name` ,`type` ,`description` ,`text` ,`linktext` ,`link` ,`durability`) VALUES('NOTICE_NEW_CONTRACT', '3', 'Occurs when a new contact is added', '{contractproduct} contract has been added to {sitename} by {userid}', 'View Contract', '{applicationurl}contract_details.php?id={contractid}', 'sticky');";
