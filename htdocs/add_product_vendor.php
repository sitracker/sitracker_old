<?php
// add_product_vendor.php - Form for adding product vendors
//
...
if (empty($submit))
{
    ...
    {
        return window.confirm('Are you sure you want to add this product vendor?');
    }
    </script>

    <h2>Add New Product Vendor</h2>
