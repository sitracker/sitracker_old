...
else
{
    ...
    if ($file!='')
    {
        ...
        else
        {
            ...
            confirmation_page('2', 'ftp_upload_file.php', "<h2>Upload Successful</h2><p align='center'><code>$ftp_url</code></code><p align='center'>Please wait while you are redirected...</p>");
