...
$strShowOnlySitesWithNoPrefferredContract = 'Show only sites with no preferred contracts';
...
$strShowSitesThatHaveLoggedNoIncidents = 'Show sites hat have logged no incidents';
