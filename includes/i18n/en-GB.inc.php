...
// list of strings (*ALPHABETICAL ORDER BY VARIABLE NAME* - ABCDEFGHIJKLMNOPQRSTUVWXYZ 0123456789)
...
$strCallsOK = 'Calls OK';
$strCannotDeleteUser = 'Sorry, this user cannot be deleted because it has been associated with one or more files, links, notes or skills/software';
$strCannotPerformOperationInDemo = 'You cannot perform this operation while in DEMO mode';
...
$strCheckUserAndRolePermissions = 'Check User and Role Permissions';
...
$strHideFromCustomer = 'Hide From Customer';
$strHidingIncidentsOlderThan = 'Hiding incidents older than %d days old';
$strHigh = 'High';
...
$strMakeVisibleToCustomer = 'Make Visible to Customer';
...
$strTriggerContactResetPassword = 'Occurs when a contact wants their password resetting';
...
$strTriggerHolidayRequested = 'Occurs when a user requests a holiday';
$strTriggerIncidentClosed ='Occurs when an incident is closed';
$strTriggerIncidentNearingSLA = 'Occurs when an incidents nears an SLA';
$strTriggerIncidentReviewDue = 'Occurs when an incident is due a review';
$strTriggerKBArticleCreated = 'Occurs when a new Knowledgebase article is created';
$strTriggerLanguageDiffers = 'Occurs when your current language setting is different to your profile setting';
$strTriggerNewContact = 'Occurs when a new contact is added';
$strTriggerNewContract = 'Occurs when a new contract is added';
$strTriggerNewHeldEmail = 'Occurs when there is a new email in the holding queue';
$strTriggerNewHeldEmailMins = 'Occurs when there is a new email in the holding queue for X minutes';
$strTriggerNewIncidentAssigned = 'Occurs when a new incident is assigned to a user';
$strTriggerNewIncidentCreated = 'Occurs when a new incident has been created';
$strTriggerNewSite = 'Occurs when a new site is added';
$strTriggerNewUser ='Occurs when a new user is added';
$strTriggerSitUpgraded = 'Occurs when the system is upgraded';
$strTriggerUserChangedStatus = 'Occurs when one of your watched engineer changes status';
$strTriggerUserResetPassword = 'Occurs when a user wants their password resetting';
...
$strYouMustEnter = 'You must enter: %s';
