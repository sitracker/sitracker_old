...
$strNoticeIncidentNearingSLA = '{incidentowner}\'s incident {incidentid} - {incidenttitle}: {nextsla} due in {nextslatime}';
...
$strNoticeNewUser = '{userrealname} has been added a new user to {applicationshortname}';
$strNotices = 'Notices';
