...
$CFGCAT['portal'] = array('portal', 'portal_kb_enabled', 'portal_site_incidents',
                          'portal_usernames_can_be_changed', 
                          'portal_creates_incidents', 'portal_interface_style');
                          
$CFGCAT['email'] = array('enable_inbound_mail', 'email_address email_options',
                         'email_password email_port', 'email_server',
                         'email_servertype',  'email_username');
